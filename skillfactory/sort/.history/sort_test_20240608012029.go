...
func TestSort(t *testing.T) {
	...
	for _, tt := range testCases {
		quickSort(tt.input)
		if !ascendingOrder(tt.input) {
			t.Error("quickSort: order is not valid")
		}
	}
	...
	for _, tt := range testCases {
		...
		if !ascendingOrder(tt.input) {
			t.Error("selectionSort: order is not valid")
		}
	}
	...
	for _, tt := range testCases {
		...
		if !ascendingOrder(tt.input) {
			t.Error("insertionSort: order is not valid")
		}
	}
	...
	for _, tt := range testCases {
		mergeSort(tt.input)
		if !ascendingOrder(tt.input) {
			t.Error("mergeSort: order is not valid")
		}
	}
	...
	for _, tt := range testCases {
		bubbleSort(tt.input)
		if !ascendingOrder(tt.input) {
			t.Error("bubbleSort: order is not valid")
		}
	}
}
